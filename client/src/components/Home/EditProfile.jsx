            ...
            <div className={Styles.modalContent}>
              ...
              <div className={Styles.imageDiv}>
                ...
                <div className={Styles.inputContainer}>
                  ...
                  <div className={Styles.textareaDiv} style={{
                      outline:
                        focusedInput === "input4"
                          ? "2px solid #0099ff"
                          : "1px solid  rgba(128, 128, 128, 0.314) ",
                     ...
                     <textarea className={Styles.area} placeholder=""
                      maxLength={150}
                      onFocus={() => {
                        setFocus("input4");
                      }}
                      rows={3}
                      onBlur={setBlur}></textarea>
                       <label
                  ...
                  <div className={Styles.DobDiv}> 
                      <span className={Styles.birthSpan}>Birth Date · <Link>Edit </Link></span>
                      <span className={Styles.Dob}>{monthNames[userDetails.dob.month -1] + " " + userDetails.dob.day +", "+ userDetails.dob.year}</span>
                  </div>
